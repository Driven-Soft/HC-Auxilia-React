...
const Cuidador = () => {
  return (
    <main>
      <Wrapper className="flex-col items-center"> {/*SEÇÃO  DO MAIN GERAL*/}
      <InfoDiv className="flex items-center pt-2 md:pt-3 px-4 mt-4 justify-center w-[80%]">
        <h1 className="p-1 sm:p-4 text-2xl md:text-4xl text-blue-700 font-bold dark:text-yellow-300">Área do Cuidador</h1>
      </InfoDiv>
      <div className="flex flex-col md:flex-row">
        ...
        <aside className="flex-1 p-4 mt-4 md:mt-0 ">
            <InfoDiv className="text-center items-center flex flex-col dark:text-yellow-300 dark:bg-black dark:border-2 dark:border-white">
            <h1 className="font-extrabold text-2xl p-2">Sobre a Área do Cuidador:</h1>
