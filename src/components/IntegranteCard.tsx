...
const IntegranteCard = ({integrante}: IntegranteCardProps) => {
  return (
    <div className="flex flex-col sm:flex-row lg:flex-col bg-white my-3 p-5 px-10 rounded-2xl items-center sm:px-10 shadow-[2px_5px_10px_rgba(0,0,0,0.3)]">
      <img 
      ...
      <div>
        ...
        <p>
          <b className="text-[#313131]">Perfil do Github: </b>
        ...
        <hr className="border-[#c9c9c9] border-b-2 rounded-4xl my-3" />
        <p>
          <b className="text-[#313131]">Perfil do LinkedIn: </b>
